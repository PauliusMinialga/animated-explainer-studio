  ...
  <div className="flex min-h-[80vh] items-center justify-center px-6">
    <div className="w-full max-w-sm">
      ...
      <div className="mt-8 space-y-3">
        <button className="flex h-11 w-full items-center justify-center gap-3 rounded-xl border bg-card text-sm font-medium transition-colors hover:bg-secondary">
