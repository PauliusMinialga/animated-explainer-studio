      ...
      <div className="mx-auto mt-16 max-w-2xl">
        <div className="peach-glow rounded-2xl p-6 shadow-xl shadow-peach/30">
          ...
          <div className="mt-4 flex justify-end">
            <button className="inline-flex h-10 items-center gap-2 rounded-xl bg-accent px-5 text-sm font-semibold text-accent-foreground transition-colors hover:bg-accent/90">
